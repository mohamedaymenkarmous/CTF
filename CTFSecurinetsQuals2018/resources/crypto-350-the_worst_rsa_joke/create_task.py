...
plaintext="The empire secret system has been exposed ! The top secret flag is : Flag{S1nGL3_PR1m3_M0duLUs_ATT4cK_TaK3d_D0wn_RSA_T0_A_Sym3tr1c_ALg0r1thm}"
...
ciphertext=encrypt_or_decrypt(text2Int(plaintext),MOD,E)
print "Ciphertext (numeric):",ciphertext
ciphertext2=base64.b64encode(int2Text(ciphertext,1024))
print "Ciphertext (Base64):",ciphertext2
 
# Decryption with the private key
plaintext=int2Text(encrypt_or_decrypt(ciphertext,MOD,D),1024)
print "Plaintext (from numeric):",plaintext
plaintext2=int2Text(encrypt_or_decrypt(text2Int(base64.b64decode(ciphertext2)),MOD,D),1024)
